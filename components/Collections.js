...
const Collections = () => {
  return (
    <div className='flex py-2 pb-5'>
        <div className='max-lg:hidden px-8 flex gap-x-2'>
            ...
            <Link href='/collections/all-products' className='relative cursor-pointer hover:opacity-90'>
                <Image src='/mobile-hero.webp' width={400} height={800} alt='Tees Collection'/>
