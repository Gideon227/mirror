...
const page = () => {
  return (
    <div className='flex flex-col px-6 py-5'>
      <FilterCollections title= 'ALL PRODUCTS | SHIRTS & POLOS'/> 
      <div className="no-scrollbar max-lg:overflow-x-scroll">
        <div className="flex flex-row gap-x-10 whitespace-nowrap my-auto pt-2 max-lg:justify-between max-lg:gap-x-7 max-lg:gallery no-scrollbar max-lg:w-full">
          ...
          <Link href='/collections/all-products/shirts-and-polos' className='font-normal text-[#452b1a] opacity-100 underline underline-[#452b1a] text-[13px]/[20px]'>SHIRTS & POLOS</Link>
          ...
          <Link href='/collections/all-products/accessories' className='font-normal text-[#452b1a] opacity-60 text-[13px]/[20px]'>ACCESSORIES</Link>
        </div>
      </div>   
      <Categorypage category='shirt-and-polo' />
    </div>
  )
}
